...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['*.stableduel.com'])
...
# ------------------------------------------------------------------------------
# CORS HEADERS
# If set to True CORS_ORIGIN_REGEX_WHITELIST setting will be ignored
CORS_ORIGIN_ALLOW_ALL = env.bool('CORS_ORIGIN_ALLOW_ALL', default=DEV)
